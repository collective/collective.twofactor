...
if REMEMBER:
        ...
        fields = [
          MyStringField(
              ...
              widget=atapi.SelectionWidget(
                  ...
                  description=u"Choose the method you would like to use for Two-factor authentication",
          ...
          MyStringField(
              ...
              widget=atapi.StringWidget(
                  ...
                  description=u"Enter your phone number if you choose to receive a code by SMS. Please use international format. Example: +15555555555",
    ...
    def getTwoFactorMethods(self):
        values = []
        factory = getUtility(IVocabularyFactory, "collective.twofactor.methods")
